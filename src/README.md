...
Goal: document the system as it is. 
Grow tests along a path of increasing generality: start with unit tests, expand them with parameterized cases, and finish with property-based checks. 
Keep code coverage on to spot missing scenarios throughout.
